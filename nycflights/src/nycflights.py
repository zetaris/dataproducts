...
st.sidebar.write(' ')
st.sidebar.write(' ')
st.sidebar.header('NYC Flights')
st.sidebar.subheader('Description')
st.sidebar.write('Enter trip departure date and departure airport.')
st.sidebar.write('Select flight number to view flight details and estimated travel time.')
# data sources
st.sidebar.subheader('Data Sources')
st.sidebar.write('Flight data from Aviation Edge Flight Schedule API.')
st.sidebar.write('Travel time predictions generated by the Zetaris platform based on Yellow Taxi Trip data accessed via NYC OpenData.')
